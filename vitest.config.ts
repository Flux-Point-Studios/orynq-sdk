...
export default defineConfig({
  resolve: {
    alias: {
      ...
      '@fluxpointstudios/orynq-sdk-hydra-batcher': resolve(__dirname, 'packages/hydra-batcher/src/index.ts'),
      '@fluxpointstudios/orynq-sdk-midnight-prover': resolve(__dirname, 'packages/midnight-prover/src/index.ts'),
      '@fluxpointstudios/orynq-sdk-attestor': resolve(__dirname, 'packages/attestor/src/index.ts'),
      '@fluxpointstudios/orynq-sdk-storage-adapters': resolve(__dirname, 'packages/storage-adapters/src/index.ts'),
      ...
      '@fluxpointstudios/orynq-sdk-tool-receipts': resolve(__dirname, 'packages/tool-receipts/src/index.ts'),
