...
export default defineConfig({
  resolve: {
    alias: {
      ...
      '@fluxpointstudios/poi-sdk-feature-telemetry': resolve(__dirname, 'packages/feature-telemetry/src/index.ts'),
      '@fluxpointstudios/poi-sdk-safety-monitor': resolve(__dirname, 'packages/safety-monitor/src/index.ts'),
      '@fluxpointstudios/poi-sdk-channel-firewall': resolve(__dirname, 'packages/channel-firewall/src/index.ts'),
