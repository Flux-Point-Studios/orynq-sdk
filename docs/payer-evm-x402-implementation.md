# @poi-sdk/payer-evm-x402 Implementation Summary

## Overview

The `@poi-sdk/payer-evm-x402` package has been implemented as an EVM Payer for the x402 payment protocol using EIP-3009 "Transfer With Authorization" for gasless token transfers.
...
- `@poi-sdk/transport-x402`: workspace:* (x402 protocol transport)
...
### Integration with @poi-sdk/client
