# @poi-sdk/payer-cardano-cip30 MeshJS Implementation Summary

## Overview

This document summarizes the implementation of the `@poi-sdk/payer-cardano-cip30` package using MeshJS for Cardano browser wallet integration. The implementation replaces the previous `lucid-cardano` dependency with `@meshsdk/core`.
...
```typescript
import { Cip30Payer, BrowserWallet } from "@poi-sdk/payer-cardano-cip30";
...
```typescript
import { Cip30Payer } from "@poi-sdk/payer-cardano-cip30";
